        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <a href="<%=path%>/complains"><sp:message code="complain.list"/></a>&nbsp;&nbsp;<small><sp:message code="complain.list"/></small>
                </section>
                ...
                <section class="content">
                    <div class="row-fluid">
                        ...
                        <div class="row">
                            <form id="queryForm" action="<%=path%>/complains" method="post">
                                <div class="col-xs-2">
                                    ...
                                    <table id="dataTable" class="table table-striped table-bordered table-hover table-condensed" align="center">
                                        <thead>
                                            <tr class="info">
                                                ...
                                                <th>用户</th>
                                                <th><sp:message code="complain.content"/></th>
                                                <th><sp:message code="complain.contactPhone"/></th>                                                
            ...
            <div class="modal-dialog" >
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><sp:message code="complain.info"/>-<sp:message code="sys.edit"/></h4>
                    </div>
                    ...
                    <div class="modal-body" >
                        <form class="form-horizontal"  id="editForm" >
                            ...
                            <div class="form-group">
                                <label for="inputName" class="col-sm-3 control-label">所属用户</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="uid" readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputName" class="col-sm-3 control-label"><sp:message code="complain.content"/></label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="content" disabled="disabled"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputName" class="col-sm-3 control-label"><sp:message code="complain.contactPhone"/></label>
                                <div class="col-sm-9">
            ...
            $(function () {
                ...
                var tables = $("#dataTable").dataTable({
                    ...
                    columns: [//对应上面thead里面的序列
                        ...
                        {"data": 'id'},
                        {"data": 'uid'}, //mData 表示发请求时候本列的列明，返回的数据中相同下标名字的数据会填充到这一列                        
