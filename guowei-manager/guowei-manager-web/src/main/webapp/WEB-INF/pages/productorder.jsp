		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<a href="<%=path%>/products"><sp:message code="menu.products"/></a>&nbsp;&nbsp;<small>商品订单详情</small>
				</section>
			...
			$(function () {
				...
				tables = $("#dataTable").dataTable({
	                ...
	                columns: [//对应上面thead里面的序列
	                    ...
	                    {"data": 'id'},
	               		{"data": 'userName', defaultContent: ""}, //mData 表示发请求时候本列的列明，返回的数据中相同下标名字的数据会填充到这一列
