		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<a href="<%=path%>/divisions"><sp:message code="menu.divisions"/></a>&nbsp;&nbsp;<small><sp:message code="division.list"/></small>
					<!-- 
					<ol class="breadcrumb">
				...
				<section class="content">
					...
					<div class="row-fluid">
						...
						<div class="row">
							<form id="queryForm" action="<%=path%>/divisions" method="post">
								<div class="col-xs-2">
			...
			<div class="modal-dialog" >
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel"><sp:message code="division.info"/>-<sp:message code="sys.edit"/></h4>
					</div>
